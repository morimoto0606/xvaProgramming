	...
	public:
		...
		TEST_METHOD(CvaLsmExposureAsianCoeffShockOneTimeBasis)
		{
			...
			//Explicit
			{
				...
				Assert::AreEqual(165.16689222621250, cva1.value(), 1e-2); //value
				Assert::AreEqual(6.2346689222621459, cva1.deriv(), 1e-2); //delta 
				Assert::AreEqual(165.16689222621250, cva2.value(), 1e-2); //value
			...
			//Implicit
			{
				...
				Assert::AreEqual(165.77073612623596, cva1.value(), 1e-2); //value
				Assert::AreEqual(6.2407073612623662, cva1.deriv(), 1e-2); //delta 
				Assert::AreEqual(165.77073612623596, cva2.value(), 1e-2); //value
		...
		TEST_METHOD(CvaLsmExposureAsianCoeffShockAverageBasis)
		{
			...
			//Explicit
			{
				...
				Assert::AreEqual(166.37144927422588, cva1.value(), 1e-2); //value
				Assert::AreEqual(6.3997144927420448, cva1.deriv(), 1e-2); //delta 
				Assert::AreEqual(166.37144927422588, cva2.value(), 1e-2); //value
